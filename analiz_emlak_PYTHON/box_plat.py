...
# Boxplot grafikleri için tema ayarları
sns.set_theme(style="whitegrid", palette="muted")

# Her sütun için boxplot grafiği oluşturma
numerical_columns = ['Fiyat', 'M2', 'Bina_Yasi', 'Oda_Sayisi_Encoded']

for column in numerical_columns:
    plt.figure(figsize=(12, 8))
    try:
        sns.boxplot(data=data, x='Bolge', y=column, palette="muted")
        ...
        plt.title(f"{column} için Boxplot Grafiği", fontsize=14)
